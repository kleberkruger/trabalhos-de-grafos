...
//AlgorithmOutput PathsAlg::dijkstra(const Graph &graph, int source) {
...
//PathsOutput bellmanFord(const Graph &graph, int source) {
//    PathsOutput out;
//
//    out.dist[source] = 0;
//    out.pred[source] = source;
//
...
//        auto w = e.weight;
//
//        if (out.dist[u] != std::numeric_limits<int>::infinity() && out.dist[u] + w < out.dist[v]) {
